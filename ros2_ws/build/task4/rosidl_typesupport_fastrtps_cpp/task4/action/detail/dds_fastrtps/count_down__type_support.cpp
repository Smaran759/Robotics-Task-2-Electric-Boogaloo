...
#include "task4/action/detail/count_down__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_Goal & ros_message)
{
  // Member: target
  cdr >> ros_message.target;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task4::action::CountDown_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_task4
const rosidl_message_type_support_t *
get_message_type_support_handle<task4::action::CountDown_Goal>()
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_Goal)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_Result & ros_message)
{
  // Member: current_count
  cdr >> ros_message.current_count;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task4::action::CountDown_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_Result)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_Feedback & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task4::action::CountDown_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_Feedback)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_Feedback__handle;
}
...
// functions for task4::action::CountDown_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  task4::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  task4::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    task4::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task4::action::typesupport_fastrtps_cpp::max_serialized_size_CountDown_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task4::action::CountDown_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_SendGoal_Request)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task4::action::CountDown_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_SendGoal_Response)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_SendGoal_Response__handle;
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_SendGoal)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task4::action::CountDown_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_GetResult_Request)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for task4::action::CountDown_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
  cdr << ros_message.status;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task4::action::typesupport_fastrtps_cpp::max_serialized_size_CountDown_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task4::action::CountDown_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_GetResult_Response)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_GetResult_Response__handle;
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_GetResult)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_GetResult__handle;
}
...
// functions for task4::action::CountDown_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task4
cdr_serialize(
  const task4::action::CountDown_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task4::action::CountDown_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        task4::action::typesupport_fastrtps_cpp::max_serialized_size_CountDown_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task4::action::CountDown_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task4::action::CountDown_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task4::action::CountDown_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task4, action, CountDown_FeedbackMessage)() {
  return &task4::action::typesupport_fastrtps_cpp::_CountDown_FeedbackMessage__handle;
}
