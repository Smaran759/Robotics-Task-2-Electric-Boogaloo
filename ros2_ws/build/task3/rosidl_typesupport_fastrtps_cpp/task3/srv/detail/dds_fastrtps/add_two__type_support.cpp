...
#include "task3/srv/detail/add_two__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const task3::srv::AddTwo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task3::srv::AddTwo_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task3::srv::AddTwo_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const task3::srv::AddTwo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task3::srv::AddTwo_Request *>(
    untyped_ros_message);
...
{
  return &task3::srv::typesupport_fastrtps_cpp::_AddTwo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task3, srv, AddTwo_Request)() {
  return &task3::srv::typesupport_fastrtps_cpp::_AddTwo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_task3
cdr_serialize(
  const task3::srv::AddTwo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task3::srv::AddTwo_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = task3::srv::AddTwo_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task3::srv::AddTwo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<task3::srv::AddTwo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &task3::srv::typesupport_fastrtps_cpp::_AddTwo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task3, srv, AddTwo_Response)() {
  return &task3::srv::typesupport_fastrtps_cpp::_AddTwo_Response__handle;
}
...
{
  return &task3::srv::typesupport_fastrtps_cpp::_AddTwo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task3, srv, AddTwo)() {
  return &task3::srv::typesupport_fastrtps_cpp::_AddTwo__handle;
}
