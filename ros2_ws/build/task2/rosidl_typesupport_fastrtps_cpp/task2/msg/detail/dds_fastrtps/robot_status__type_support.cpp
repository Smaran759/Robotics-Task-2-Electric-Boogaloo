...
#include "task2/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const task2::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  task2::msg::RobotStatus & ros_message)
{
  // Member: bot_name
  cdr >> ros_message.bot_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = task2::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const task2::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<task2::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  return &task2::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task2, msg, RobotStatus)() {
  return &task2::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
