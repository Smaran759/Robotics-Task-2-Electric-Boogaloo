...
static const _RoboStatus_type_support_symbol_names_t _RoboStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, task2, msg, RoboStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, task2, msg, RoboStatus)),
  }
};
...
{
  return &::task2::msg::rosidl_typesupport_cpp::RoboStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, task2, msg, RoboStatus)() {
  return get_message_type_support_handle<task2::msg::RoboStatus>();
}
