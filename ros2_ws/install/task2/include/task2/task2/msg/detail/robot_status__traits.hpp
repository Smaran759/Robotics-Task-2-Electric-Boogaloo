...
#ifndef TASK2__MSG__DETAIL__ROBOT_STATUS__TRAITS_HPP_
#define TASK2__MSG__DETAIL__ROBOT_STATUS__TRAITS_HPP_
...
inline void to_yaml(
  const task2::msg::RobotStatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const task2::msg::RobotStatus & msg)
{
  return task2::msg::to_yaml(msg);
}

template<>
inline const char * data_type<task2::msg::RobotStatus>()
{
  return "task2::msg::RobotStatus";
}

template<>
inline const char * name<task2::msg::RobotStatus>()
{
  return "task2/msg/RobotStatus";
}

template<>
struct has_fixed_size<task2::msg::RobotStatus>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<task2::msg::RobotStatus>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<task2::msg::RobotStatus>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // TASK2__MSG__DETAIL__ROBOT_STATUS__TRAITS_HPP_
